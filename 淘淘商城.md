...
![单点登录系统架构](https://i.ibb.co/T40cbtm/image.png)

### 创建sso工程

创建一个继承taotao-parent的web工程taotao-sso。
...
在浏览器中输入<http://localhost:8084/user/check/zhangsan/1>，返回{"status":200,"msg":"OK","data":true}，说明数据校验接口测试成功。
...
```
email=15151251%40gmail.com&phone=1874325525&password=jwlkt15152&username=jack
```
